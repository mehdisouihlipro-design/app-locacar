...
router.post('/', async (req: AuthRequest, res: Response) => {
  try {
    ...
    await global.db.post('/customers', stampCreate({ id, name, phone, email, address, city, postal_code, country, id_number, notes }, req), { headers: { Prefer: 'resolution=merge-duplicates' } });
