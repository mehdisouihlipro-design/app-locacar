...
> **Suivi d'implémentation** : Phase 1A (terminée) — BR22 (second RIB) et BR23 (traçabilité création/modification) sont **✅ implémentées** (DB, backend, frontend, documentation). Phase 1B (terminée) — BR24 (tri et filtre génériques) est **✅ implémentée** (frontend). BR18-21 et BR25-31 restent à l'état de spécification cible, à planifier dans les phases suivantes (2, 3, 4).
